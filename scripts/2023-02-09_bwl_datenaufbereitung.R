...
bwl_results_raw <- read_csv2("data_raw/bundeswahlleiter_kerg.csv", 
                             skip = 5,
                             col_names = FALSE)
...
bwl_str_raw <- read_csv2("data_raw/bundeswahlleiter_strukturdaten.csv", 
                             skip = 8)
...
saveRDS(bwl, file = "data/bwl_2023-02-09.rds")
